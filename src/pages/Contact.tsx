          ...
          <div className="grid grid-cols-12 gap-3 lg:gap-4 auto-rows-[110px] lg:auto-rows-[140px]">
            ...
            <div className="col-span-6 lg:col-span-3 row-span-2 rounded-2xl bg-secondary p-6 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="space-y-1 relative">
                ...
                <p className="font-display text-base lg:text-lg text-foreground leading-tight break-all">admin@seafood.jawanaturalwealth.com</p>
                <p className="font-display text-base lg:text-lg text-foreground leading-tight break-all">salesseafoodjnw@gmail.com</p>
              </div>
            </div>
            <div className="col-span-6 lg:col-span-4 row-span-2 rounded-2xl bg-primary text-primary-foreground p-6 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="space-y-1 relative">
                <p className="font-display text-2xl lg:text-4xl leading-tight">+62 851-8863-2609</p>
                <p className="font-display text-2xl lg:text-4xl leading-tight">+62 851-8543-3397</p>
                <p className="font-display text-2xl lg:text-4xl leading-tight">+62 851-9657-2911</p>
              </div>
            </div>
          </div>
        </div>
